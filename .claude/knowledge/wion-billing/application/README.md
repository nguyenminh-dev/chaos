...
### ✅ [Wallet Management](./use-cases/wallet-management.md) - IMPLEMENTED
**Business Goal**: Create and manage tenant wallets with multi-asset support

**Actor**: System (tenant creation), Tenant Admin

**Aggregates Involved**:
- Wallet (balance management)

**Key Workflows**:
- Wallet creation for new tenants
- Multi-asset management
- Balance operations (credit, reserve, confirm)

**Implementation Status**: ✅ **COMPLETE**

---

### 🔄 [Consume Credit](./use-cases/consume-credit.md) - PLANNED
...
**Implementation Status**: 🔄 **PLANNED** - Next after Payment domain

---

### 🔄 [Process Payment](./use-cases/process-payment.md) - PLANNED
...
**Implementation Status**: 🔄 **PLANNED** - Priority domain to implement

---

### 🔄 [Handle Webhook](./use-cases/handle-webhook.md) - PLANNED
...
**Implementation Status**: 🔄 **PLANNED** - Depends on Payment domain

---

### 🔄 [Create Invoice](./use-cases/create-invoice.md) - PLANNED
...
**Implementation Status**: 🔄 **PLANNED** - After Payment domain
