...
**Purpose**: Notify that a new wallet has been created for a user
...
**Trigger**: User registration triggers wallet creation
...
### Ordering
- **Per User**: Events for the same user are ordered
