...
### T-PayGate Integration Events

#### BankConnectionConnected
- **Trigger**: When bank connection successfully established
- **Consumers**: Monitoring Service, Configuration Service
- **Documentation**: [T-PayGate Domain Events](../domains/payment/tpaygate/domain-events.md)

#### BankConnectionDisconnected
- **Trigger**: When bank connection terminated
- **Consumers**: Monitoring Service, Configuration Service
- **Documentation**: [T-PayGate Domain Events](../domains/payment/tpaygate/domain-events.md)

#### TpgBillCreated
- **Trigger**: When payment bill created with QR code
- **Consumers**: Monitoring Service, Analytics Service
- **Documentation**: [T-PayGate Domain Events](../domains/payment/tpaygate/domain-events.md)

#### TpgBillPaid
- **Trigger**: When payment completed successfully
- **Consumers**: Invoice Service, Wallet Service, Ledger Service, Monitoring Service
- **Documentation**: [T-PayGate Domain Events](../domains/payment/tpaygate/domain-events.md)

#### TpgPaymentNotificationReceived
- **Trigger**: When webhook received from T-PayGate
- **Consumers**: Monitoring Service
- **Documentation**: [T-PayGate Domain Events](../domains/payment/tpaygate/domain-events.md)
